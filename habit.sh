...
CUDA_VISIBLE_DEVICES=0 python /home/mila/m/manoosh.samiei/scratch/The-Bayesian-Behavior-Framework/run_habitization_experiment.py --seed 12 --verbose 1 --gui 0 --savepath './sac_data/' --details_savepath='./sac_details/' --only_sac='True'
