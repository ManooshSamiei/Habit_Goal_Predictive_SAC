...
id = 12; % you may change to check different random seeds

%N = 5; 

episodes = 0:1000:40000%, 5000, 15000, 20000, 25000, 27500, 30000, 37000];
N = length(episodes)
% ----------------------------------------------
...
for stp = episodes 
    ...
    % draw the maze shape
    count = count + 1;
    subplot(2, round(length(episodes)/2), count)
    ...
    filename = sprintf("tmaze_habitization_%d_episode_%d.mat", id, stp);
