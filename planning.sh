...
CUDA_VISIBLE_DEVICES=0,1 python /home/mila/m/manoosh.samiei/scratch/The-Bayesian-Behavior-Framework/run_planning_experiment.py --seed 42 --verbose 1 --gui 0 --savepath './data' --details_savepath='./details' --planning_savepath='./planning'
